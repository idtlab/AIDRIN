...
def create_app():
    ...
    app.config["CELERY"] = {
        ...
        # Do not store task results in backend, unless methods call for it
        "task_ignore_result": True,
        "task_soft_time_limit": 60,  # Task is soft killed
        "task_time_limit": 120,  # Task is force killed after this time
        # prevent default celery logging configuration

...
- [Data quality](#data-quality): completeness, duplicity, outliers, row_level_completeness, feature_coverage_ratio, temporal_completeness, null_count_trend
...
| `required-columns`           | row_level_completeness                         |
| `threshold`                  | feature_coverage_ratio                         |
| `timestamp-column`           | temporal_completeness                          |
| `frequency`                  | temporal_completeness                          |
| `batch-column`               | null_count_trend                               |
| `target-columns`             | null_count_trend                               |

...
- [ ] Milestone 1: Implement the core metric, filesystem security semantics, metadata, and format-focused unit tests.
- [ ] Milestone 2: Integrate the headless API, CLI, and batch configuration with focused tests.
